...
public class MainActivity extends AppCompatActivity {
    ...
    private MyDialog mFullScreenDialog;
    ...
    private void initFullscreenDialog() {
        mFullScreenDialog = new MyDialog(this, android.R.style.Theme_Black_NoTitleBar_Fullscreen) {
    ...
    protected void onResume() {
        ...
        if (mExoPlayerView == null) {
            ...
            String streamUrl = "http://plmgr-infolink.cdnvideo.ru/1tvstream/playlist.m3u8";
